...
${OBJECTDIR}/Test_2D.o: Test_2D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Test_2D.o Test_2D.cpp

${OBJECTDIR}/Test_2D3D.o: Test_2D3D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Test_2D3D.o Test_2D3D.cpp

${OBJECTDIR}/Test_3D.o: Test_3D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Test_3D.o Test_3D.cpp

${OBJECTDIR}/Test_3D_Intersect.o: Test_3D_Intersect.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Test_3D_Intersect.o Test_3D_Intersect.cpp

${OBJECTDIR}/Test_STL.o: Test_STL.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Test_STL.o Test_STL.cpp
